...
class CNNModel(nn.Module):
    def __init__(self, kernel_size = 3, is_deep = False):
        super().__init__()
        ...
        if not self.is_deep:
            ...
            self.conv2 = nn.Conv2d(32, 64, kernel_size=self.kernel_size, padding=self.padding)
            ...
            self.conv2 = nn.Conv2d(32, 64, kernel_size=self.kernel_size, padding=self.padding)
            self.bn2 = nn.BatchNorm2d(64)
            self.conv3 = nn.Conv2d(64, 128, kernel_size=self.kernel_size, padding=self.padding)
            self.bn3 = nn.BatchNorm2d(128)
            self.conv4 = nn.Conv2d(128, 256, kernel_size=self.kernel_size, padding=self.padding)
